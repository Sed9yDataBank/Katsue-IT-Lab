...
@EnableJpaRepositories(
        ...
        basePackages = { "com.ktasueitlab.katsueserver.contact.repository",
                         "com.ktasueitlab.katsueserver.contact.exception",
                         "com.ktasueitlab.katsueserver.contact.service",
                         "com.ktasueitlab.katsueserver.contact.controller",  }
)
public class DataBaseContactConfiguration {

    @Bean
    @ConfigurationProperties("app.jpa.contact")
    ...
    public LocalContainerEntityManagerFactoryBean contactEntityManagerFactory(final EntityManagerFactoryBuilder builder,
